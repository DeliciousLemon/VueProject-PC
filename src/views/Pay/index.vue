  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <button class="btn" @click="pay($route.query.orderID)">
            立即支付
          </button>
        </div>
        <div class="otherpay">
...
export default {
  ...
  methods: {
    async pay(id) {
      this.code = await reqPay(id);
      QRcode.toDataURL(this.code.data.codeUrl)
      .then((url) => {
      ...
      .catch(()=>{
        this.$message.error("支付遇到问题，请稍后重试")
      });
    },
  },
};
